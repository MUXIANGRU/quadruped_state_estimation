                             ...
                             const Eigen::Isometry3d& delta_camera)
{
  ...
  ////MXR::note
  ////just for debug
  //std::cout<<"相机和身体之间的坐标变换:"<<std::endl;
  //std::cout<<camera_to_body_.matrix()<<std::endl;
  std::cout<<"delta_camera is shown as followed....:"<<std::endl;
  std::cout<<delta_camera.matrix()<<std::endl;
