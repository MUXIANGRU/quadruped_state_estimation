...
public:
    ...
    enum Mode {THRESHOLD = 0, HYSTERESIS, REGRESSION};  //menkan zhihou huigui
...
public:
    ...
    inline LegBoolMap getStance(const double time,
                                ...
                                const Vector3d& xd = Vector3d(0, 0, 0),    //linear velocity/angularity
                                const Vector3d & xdd  = Vector3d(0, 0, 0), //linear and angular accelaration
