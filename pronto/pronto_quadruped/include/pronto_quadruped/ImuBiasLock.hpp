...
public:
    // the measurement and index sizes is 8: 3 for gyro bias, 3 for accel bias and 2 for roll/pitch estimation
...
protected:
    std::vector <Eigen::Vector3d> gyro_bias_history_,gyro_bias_history_test;
    std::vector <Eigen::Vector3d> accel_bias_history_,accel_bias_history_test;
    bool do_record = true;
