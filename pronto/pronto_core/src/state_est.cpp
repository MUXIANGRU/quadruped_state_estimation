...
StateEstimator::StateEstimator(RBISResetUpdate * init_state, //filter update
    ...
    utime_history_span(history_span)
{
  ...
  std::cout<<"@@@@@@@@@@@@@@@@@"<<std::endl;
  std::cout<<"state estimator creating..............."<<std::endl;
  std::cout<<"@@@@@@@@@@@@@@@@@"<<std::endl;
...
bool StateEstimator::getInterpolatedPose(const uint64_t &utime, Eigen::Isometry3d& pose) const {
    ...
    pose.translate(pos);//initialize the HomoTransMatrix by the translation and orientation
    pose.rotate(orient);
    return true;
}
...
void StateEstimator::addUpdate(RBISUpdateInterface * update, bool roll_forward)
{
    ...
    std::cout<<"=========================================="<<std::endl;
    std::cout<<"state estimator is updating..............."<<std::endl;
    std::cout<<"=========================================="<<std::endl;
//    std::cout<<utime_history_span<<std::endl;
 ...
 // Add current update to history
  ...
  //MXR::note:
  //这个好像是取决于更新频率????
  //std::cout<<history.toString(update->utime,3) << std::endl;
  //Updatemap <1748931000, reset>
  //Updatemap <1748934000, legodo>
  //Updatemap <1748936000, ins>
  //Updatemap <1748941000, ins>
...
//  std::cout<<"the newest_utime is:          "<<newest_utime<<std::endl;
//  std::cout<<"the oldest_utime is:          "<<oldest_utime<<std::endl;
  // Resize the history
