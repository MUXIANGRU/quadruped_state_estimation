...
RBISUpdateInterface::sensor_enum RBISUpdateInterface::sensor_enum_from_char(char sensor_char)
{
  ...
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
  std::cout<<"sensor choosing...."<<std::endl;
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
...
void RBISResetUpdate::updateFilter(const RBIS & prior_state, const RBIM & prior_cov, double prior_loglikelihood)
{
  ...
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
  std::cout<<"reset update updating++++++++++++++"<<std::endl;
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
#if DEBUG_MODE
...
void RBISIMUProcessStep::updateFilter(const RBIS & prior_state, const RBIM & prior_cov, double prior_loglikelihood)
{
  ...
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
  std::cout<<"imu process update updating++++++++++++++"<<std::endl;
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
...
#endif
//  std::cout<<"[RBISIMUProcessStep::updateFilter]"<<std::endl;
//  std::cout<<dt<<std::endl;
//  std::cout<<"[RBISIMUProcessStep::updateFilter]"<<std::endl;
  //MXR::note
  //dt 0.0025 or 0.005 to match the IMU frequency
...
void RBISIndexedMeasurement::updateFilter(const RBIS & prior_state, const RBIM & prior_cov, double prior_loglikelihood)
{
  ...
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
  std::cout<<"index update updating++++++++++++++"<<std::endl;
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
#if DEBUG_MODE
    std::cout << "mfallon a\n";
                                                         ...
                                                         double prior_loglikelihood)
{
  ...
  double current_likelihood = indexedPlusOrientationMeasurement(measurement,
                                                                ...
                                                                dcov);
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
  std::cout<<"iIndexedPlusOrientation updating++++++++++++++"<<std::endl;
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
                                              ...
                                              double prior_loglikelihood)
{
  ...
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
  std::cout<<"OpticalFlow update updating++++++++++++++"<<std::endl;
  std::cout<<"$$$$$$$$$$$$$$$$$$"<<std::endl;
  //    RBIS dstate;
  //    RBIM dcov;
  //
