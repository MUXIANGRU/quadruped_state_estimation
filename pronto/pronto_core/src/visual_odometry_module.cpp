...
using Mode = pronto::VisualOdometryMode;
namespace pronto {
...
Update* VisualOdometryModule::processMessage(const PoseMeasurement *msg,
                                             StateEstimator *est)
{

    std::cout<<"%%%%%%%%%%%%%%%"<<std::endl;
    std::cout<<"VisualOdometryModule::processMessage............."<<std::endl;
    std::cout<<"%%%%%%%%%%%%%%%"<<std::endl;
    switch(mode_) {
    ...
    case Mode::MODE_POSITION_ORIENT :
    {
...
bool VisualOdometryModule::processMessageInit(const PoseMeasurement *msg,
                                              const std::map<std::string, bool> &sensor_initialized,
                                              const RBIS &default_state,
                                              const RBIM &default_cov,
                                              RBIS &init_state,
