...
{
    std::cout<<"!!!!!!!!!!!!!!!!!!"<<std::endl;
    std::cout<<"imu_bias_lock"<<std::endl;
    std::cout<<"!!!!!!!!!!!!!!!!!!"<<std::endl;
}
                                                    ...
                                                    StateEstimator *est)
{
    ...
    //MXR::just for debug
    //till now ,this module isn't used
    std::cout<<" ImuBiasLockROS::processMessage.............."<<std::endl;

    msgToImuMeasurement(*msg, bias_lock_imu_msg_);

//  std::cout<<"+++++++++++++++"<<std::endl;
//  std::cout<<bias_lock_imu_msg_.omega<<std::endl;
//  std::cout<<"+++++++++++++++"<<std::endl;
  ...
  ROS_WARN("ImuBiasLockROS::processMessage running");
  return update;
}
