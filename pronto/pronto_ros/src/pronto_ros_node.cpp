...
//???
//Is this node really running
//MXR::Sure! THIS NODE ISM'T RUNNING!!!
int main(int argc, char** argv) {
    ...
    //MXR::just for debug
    ROS_WARN("pronto_ros_node.cpp running.........");
    ROS_WARN("pronto_ros_node.cpp running.........");
    ROS_WARN("pronto_ros_node.cpp running.........");
    ...
    if(!nh.getParam("/state_estimator_pronto/init_sensors", init_sensors)){
        ROS_ERROR("Not able to get init_sensors param");
    }

    if(!nh.getParam("/state_estimator_pronto/active_sensors", active_sensors)){
        ROS_ERROR("Not able to get active_sensors param");
    }
    bool publish_pose = false;
    if(!nh.getParam("/state_estimator_pronto/publish_pose", publish_pose)){
    ...
    {
        //MXR::just for debug
        std::cout<<"sensorlist testing......."<<std::endl;
        std::cout<<"sensorlist testing......."<<std::endl;
        std::cout<<"sensorlist testing......."<<std::endl;
