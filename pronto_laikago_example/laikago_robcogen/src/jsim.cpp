...
iit::laikago::dyn::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const iit::laikago::dyn::JSIM& iit::laikago::dyn::JSIM::update(const JointState& state) {
...
void iit::laikago::dyn::JSIM::computeL() {
...
void iit::laikago::dyn::JSIM::computeInverse() {
    computeLInverse();
...
void iit::laikago::dyn::JSIM::computeLInverse() {
