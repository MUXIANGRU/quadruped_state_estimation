...
const iit::laikago::dyn::ForwardDynamics::ExtForces
    iit::laikago::dyn::ForwardDynamics::zeroExtForces(Force::Zero());

iit::laikago::dyn::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void iit::laikago::dyn::ForwardDynamics::fd(
    JointState& qdd,
    Acceleration& base_a,
