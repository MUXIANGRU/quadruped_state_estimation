...
using namespace iit::laikago::dyn;

// Initialization of static-const data
const iit::laikago::dyn::InverseDynamics::ExtForces
iit::laikago::dyn::InverseDynamics::zeroExtForces(Force::Zero());

iit::laikago::dyn::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void iit::laikago::dyn::InverseDynamics::id(
...
void iit::laikago::dyn::InverseDynamics::G_terms_fully_actuated(
...
void iit::laikago::dyn::InverseDynamics::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
void iit::laikago::dyn::InverseDynamics::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
...
void iit::laikago::dyn::InverseDynamics::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'LH_SHANK'
