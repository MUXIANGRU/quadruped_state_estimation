#ifndef IIT_LAIKAGO_JSIM_H_
#define IIT_LAIKAGO_JSIM_H_
 ...
 */
class JSIM : public iit::rbd::StateDependentMatrix<iit::laikago::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<iit::laikago::JointState, 18, 18, JSIM> Base;
    public:
