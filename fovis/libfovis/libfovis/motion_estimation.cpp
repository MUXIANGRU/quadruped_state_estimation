    ...
    const VisualOdometryOptions& options)
{
  ...
  _inlier_max_reprojection_error = 30;
                                ...
                                const Eigen::MatrixXd &init_motion_cov)
{
  ...
  *_motion_estimate_covariance = init_motion_cov;
  ...
  std::cout<<"I want to know the first status of estimator: "<<_estimate_status<<std::endl;
  ...
  std::cout<<"I want to know the second status of estimator: "<<_estimate_status<<std::endl;
  tictoc("refineMotionEstimate");

  // compute inlier reprojection error
  tictoc("computeReprojectionError");
  computeReprojectionError();
   std::cout<<"the first _mean_reprojection_error: "<<_mean_reprojection_error<<std::endl;
  tictoc("computeReprojectionError");

  // remove features with a high reprojection error from the inlier set
  std::cout<<"########################"<<std::endl;
  std::cout<<_num_matches<<std::endl;
  std::cout<<"########################"<<std::endl;
  ...
  for (int m_ind = 0; m_ind < _num_matches; m_ind++) {
    ...
    if (!match.inlier)
      continue;
    std::cout<<"@@@@@@@@  "<<match.reprojection_error<<std::endl;
  ...
  tictoc("refineMotionEstimate");
  refineMotionEstimate();
  std::cout<<"I want to know the last status of estimator: "<<_estimate_status<<std::endl;
  tictoc("refineMotionEstimate");

  // compute new reprojection error
  tictoc("computeReprojectionError");
  computeReprojectionError();
  std::cout<<"the second _mean_reprojection_error: "<<_mean_reprojection_error<<std::endl;
  tictoc("computeReprojectionError");
  ...
  //std::cout<<"I want to know the status of estimator: "<<_estimate_status<<std::endl;
}
...
{
  std::cout<<"_num_inliers is : "<<_num_inliers<<std::endl;
  std::cout<<"_min_features_for_valid_motion_estimate : "<<_min_features_for_valid_motion_estimate<<std::endl;
  if (_num_inliers < _min_features_for_valid_motion_estimate) {
    _estimate_status = INSUFFICIENT_INLIERS;
    return;
  }
