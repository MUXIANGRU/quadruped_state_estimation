...
#include<simpledog_robcogen/inverse_dynamics.h>
#include<simpledog_robcogen/jsim.h>
...
private:
    iit::simpledog::dyn::InertiaProperties inertia_prop_;   //the properties of inertia
    iit::simpledog::MotionTransforms motion_transf_;  //6x6 transmition matrix
    iit::simpledog::ForceTransforms force_transf_;    //6x6 transmition matrix
    iit::simpledog::dyn::InverseDynamics inverse_dynamics_;
    iit::simpledog::dyn::JSIM jsim_;  //joint space inertia matrix
