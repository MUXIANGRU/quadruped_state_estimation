#ifndef IIT_ROBOT_SIMPLEDOG_FORWARD_DYNAMICS_H_
#define IIT_ROBOT_SIMPLEDOG_FORWARD_DYNAMICS_H_
...
/**
 * The Forward Dynamics routine for the robot simpledog.
 *
...
public:
     ...
     *     the robot simpledog, which will be used by this instance
