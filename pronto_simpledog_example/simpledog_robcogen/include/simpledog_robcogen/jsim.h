#ifndef IIT_SIMPLEDOG_JSIM_H_
#define IIT_SIMPLEDOG_JSIM_H_
...
/**
 * The type of the Joint Space Inertia Matrix (JSIM) of the robot simpledog.
 */
class JSIM : public iit::rbd::StateDependentMatrix<iit::simpledog::JointState, 18, 18, JSIM>
{
    private:
        typedef iit::rbd::StateDependentMatrix<iit::simpledog::JointState, 18, 18, JSIM> Base;
    public:
