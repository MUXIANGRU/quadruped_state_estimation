...
const iit::simpledog::dyn::ForwardDynamics::ExtForces
    iit::simpledog::dyn::ForwardDynamics::zeroExtForces(Force::Zero());

iit::simpledog::dyn::ForwardDynamics::ForwardDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
void iit::simpledog::dyn::ForwardDynamics::fd(
    JointState& qdd,
    Acceleration& base_a,
