#include "simpledog_robcogen/jacobians.h"


iit::simpledog::Jacobians::Jacobians()
:    fr_base_J_LF_FOOT(),
    fr_base_J_RF_FOOT(),
    fr_base_J_LH_FOOT(),
    fr_base_J_RH_FOOT(),
...
void iit::simpledog::Jacobians::updateParameters(const Params_lengths& _lengths, const Params_angles& _angles)
{
    lengths = _lengths;
    angles = _angles;
    //params.trig.update();
...
iit::simpledog::Jacobians::Type_fr_base_J_LF_FOOT::Type_fr_base_J_LF_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_fr_base_J_LF_FOOT& iit::simpledog::Jacobians::Type_fr_base_J_LF_FOOT::update(const JointState& q)
{
...
iit::simpledog::Jacobians::Type_fr_base_J_RF_FOOT::Type_fr_base_J_RF_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_fr_base_J_RF_FOOT& iit::simpledog::Jacobians::Type_fr_base_J_RF_FOOT::update(const JointState& q)
{
...
iit::simpledog::Jacobians::Type_fr_base_J_LH_FOOT::Type_fr_base_J_LH_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_fr_base_J_LH_FOOT& iit::simpledog::Jacobians::Type_fr_base_J_LH_FOOT::update(const JointState& q)
{
...
iit::simpledog::Jacobians::Type_fr_base_J_RH_FOOT::Type_fr_base_J_RH_FOOT()
{
    (*this)(0,0) = 1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_fr_base_J_RH_FOOT& iit::simpledog::Jacobians::Type_fr_base_J_RH_FOOT::update(const JointState& q)
{
...
iit::simpledog::Jacobians::Type_imu_link_J_LF_FOOT::Type_imu_link_J_LF_FOOT()
{
    (*this)(0,0) = -1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_imu_link_J_LF_FOOT& iit::simpledog::Jacobians::Type_imu_link_J_LF_FOOT::update(const JointState& q)
{
    Scalar sin_q_LF_HAA  = ScalarTraits::sin( q(LF_HAA) );
    Scalar cos_q_LF_HAA  = ScalarTraits::cos( q(LF_HAA) );
    Scalar sin_q_LF_HFE  = ScalarTraits::sin( q(LF_HFE) );
...
iit::simpledog::Jacobians::Type_imu_link_J_RF_FOOT::Type_imu_link_J_RF_FOOT()
{
    (*this)(0,0) = -1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_imu_link_J_RF_FOOT& iit::simpledog::Jacobians::Type_imu_link_J_RF_FOOT::update(const JointState& q)
{
    Scalar sin_q_RF_HAA  = ScalarTraits::sin( q(RF_HAA) );
    Scalar cos_q_RF_HAA  = ScalarTraits::cos( q(RF_HAA) );
    Scalar sin_q_RF_HFE  = ScalarTraits::sin( q(RF_HFE) );
...
iit::simpledog::Jacobians::Type_imu_link_J_LH_FOOT::Type_imu_link_J_LH_FOOT()
{
    (*this)(0,0) = -1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_imu_link_J_LH_FOOT& iit::simpledog::Jacobians::Type_imu_link_J_LH_FOOT::update(const JointState& q)
{
    Scalar sin_q_LH_HAA  = ScalarTraits::sin( q(LH_HAA) );
    Scalar cos_q_LH_HAA  = ScalarTraits::cos( q(LH_HAA) );
    Scalar sin_q_LH_HFE  = ScalarTraits::sin( q(LH_HFE) );
...
iit::simpledog::Jacobians::Type_imu_link_J_RH_FOOT::Type_imu_link_J_RH_FOOT()
{
    (*this)(0,0) = -1.0;
    (*this)(0,1) = 0.0;
    (*this)(0,2) = 0.0;
...
const iit::simpledog::Jacobians::Type_imu_link_J_RH_FOOT& iit::simpledog::Jacobians::Type_imu_link_J_RH_FOOT::update(const JointState& q)
{
    Scalar sin_q_RH_HAA  = ScalarTraits::sin( q(RH_HAA) );
    Scalar cos_q_RH_HAA  = ScalarTraits::cos( q(RH_HAA) );
    Scalar sin_q_RH_HFE  = ScalarTraits::sin( q(RH_HFE) );
