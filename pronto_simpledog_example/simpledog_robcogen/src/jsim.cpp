...
iit::simpledog::dyn::JSIM::JSIM(InertiaProperties& inertiaProperties, ForceTransforms& forceTransforms) :
...
const iit::simpledog::dyn::JSIM& iit::simpledog::dyn::JSIM::update(const JointState& state) {
...
void iit::simpledog::dyn::JSIM::computeL() {
...
void iit::simpledog::dyn::JSIM::computeInverse() {
    computeLInverse();
...
void iit::simpledog::dyn::JSIM::computeLInverse() {
