...
using namespace iit::simpledog::dyn;

// Initialization of static-const data
const iit::simpledog::dyn::InverseDynamics::ExtForces
iit::simpledog::dyn::InverseDynamics::zeroExtForces(Force::Zero());

iit::simpledog::dyn::InverseDynamics::InverseDynamics(InertiaProperties& inertia, MotionTransforms& transforms) :
...
{
#ifndef EIGEN_NO_DEBUG
    std::cout << "Robot simpledog, InverseDynamics::InverseDynamics()" << std::endl;
...
void iit::simpledog::dyn::InverseDynamics::id(
...
void iit::simpledog::dyn::InverseDynamics::G_terms_fully_actuated(
...
void iit::simpledog::dyn::InverseDynamics::C_terms_fully_actuated(
    Force& baseWrench, JointState& jForces,
...
void iit::simpledog::dyn::InverseDynamics::id_fully_actuated(
        Force& baseWrench, JointState& jForces,
...
void iit::simpledog::dyn::InverseDynamics::secondPass_fullyActuated(JointState& jForces)
{
    // Link 'LH_SHANK'
